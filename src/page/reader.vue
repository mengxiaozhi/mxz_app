    ...
    <NSpin :show="loading">
        <div class="pb-20">
            ...
            <div class="px-4">
                ...
                <h1 v-else class="text-2xl font-bold mb-2 text-md-on-surface dark:text-dark-md-on-surface">
                    {{ article?.title }}
                </h1>
                <div
                ...
                <div v-html="article?.content" @click="handleImageClick"
                    class="text-md-on-surface-variant dark:text-dark-md-on-surface-variant article-content"></div>
                <br>
        ...
        setup() {
            ...
            const handleImageClick = (event) => {
                if (event.target.tagName === "IMG") {
                    ...
                    window.open(imageUrl, "_blank"); // 在新標籤頁打開圖片 URL
                }
            };
